...
3.  How many elements in x are equal or bigger than 10?
...
2.  Create a cleaned data frame without the repeated observations.
...
4.  How many NA's there are in profits?

5.  Is there any company that appears twice in the forbes list?
...
### 3. Use the summary tool and see how can you answer the previous questions without any trouble.
...
3.  Use `cut()` to create the column marketvalue_cat, so you will have 3 categorical bins of "Low", "Medium" and "High" for the marketvalue.
...
2.  How large is the data.frame? use only 1 function to get the answer.
...
1.  Print five-number summary using one function, and afterward analyze the result.
