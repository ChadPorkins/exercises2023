...
1.  Create a new data frame named "TOP10" that contains only the 10
    deepest depths.
...
1.  Create a new data frame named noise_location that contains latitude,
...
6.  save the noise_location data frame in csv format to your local
    folder.
