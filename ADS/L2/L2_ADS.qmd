...
### 1.1 The basis of any successful code is first of all to know which files we are working with and navigate through directories.

1.  Run pwd command (Print working directory), where are you right now?

2.  Run `pwd` commnand (Print working directory), where are you right
    now?

3.  Run the `ls -la` command what do you get?

4.  change directory to the Report folder, what files are there?

5.  where does cd . take you?

6.  where does cd .. take you?

7.  where does cd \~ take you?

8.  Return back to the Report folder, where does cd \~/../. take you?

## 1.1 Answer

Run pwd commnand (Print working directory), where are you right now?

You should be in \~/ADS_L2 inside the lesson directory that you copied
...
1.  Create a new folder named backup, Make a copy of Q1.csv in the
    backup folder, and name the new file Q1.bck.

2.  Copy Q2.csv and Q3.csv from the seasonal directory into the backup
...
8.  create a new directory called yearly below your home directory. Now
    that yearly exists, create another directory called 2017 inside it
...
create a new folder named backup, Make a copy of Q1.csv in the backup folder, name the new file Q1.bck.
...
Copy Q2.csv and Q3.csv from the seasonal directory into the backup directory without changing your current working directory.

cp  ~/ADS_L2/Report/Q1.csv ~/ADS_L2/Report/Q2.csv Backup
...
Now that yearly exists, create another directory called 2017 inside it
without leaving your home directory.
...
tail -n +7 Q3.csv
 ...
 -n +7 will display all lines but only the first six lines of Q3.csv
...
3.  Count how many lines contain the he word Italy in Forbes2000.csv.
...
Count how many lines contain the he word Italy in Forbes2000.csv
...
-   Download nano for
    [Windows](https://www.nano-editor.org/dist/win32-support/nano-git-0d9a7347243.exe).

-   Rename the file to nano.exe

-   Move it to C:\Program Files\Git\usr\bin

-   Open git for Windows and issue the following command: git config
    --global core.editor "winpty nano"

-   And that's it! Next git opens a text editor, it will be nano run
    inside of MINGW64.

2.  Add your name and your birthday in the words.txt file.
